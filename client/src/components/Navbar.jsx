...
//           <div
//             className="w-10 h-10 rounded-lg bg-gradient-to-br from-[rgb(204,78,0)] via-[rgb(255,112,40)] to-[#1f1f1f] flex items-center justify-center text-black font-bold shadow-md"
...
//               style="width:100%; height:auto; margin-bottom: 10px; border-radius: 6px;"
//             /> */}
//             AutomationEdge
//           </button>
//         </div>
